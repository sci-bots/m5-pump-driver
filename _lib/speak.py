# Adapted from https://github.com/m5stack/M5Stack_MicroPython/
#   MicroPython_BUILD/components/micropython/esp32/modules/m5flow/m5stack.py
import machine
import time
class Speaker:
  ...
  def checkInit(self):
    if self.pwm_init == False:
      self.pwm_init = True
      self.pwm = machine.PWM(machine.Pin(self.pin, value=0), freq=1, duty=0)
